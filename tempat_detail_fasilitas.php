...
<div class="row">
    <div class="col-md-6">
        ...
        <?=$row->keterangan?>
           ...
           <div>
        <b> Latitude : <?=$row->lat?>   &nbsp  &nbsp   &nbsp     &nbsp     Longitude : <?=$row->lng?> </b>
        </div>
    </div>
    <div class="col-md-6">
        <p>
            <a href="?m=tempat_fasilitas" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Lihat semua tempat</a>
        ...
        <div class="row">
            <?php
            $rows = $db->get_results("SELECT * FROM tb_galeri WHERE id_fasilitas='$_GET[ID]'");
            foreach($rows as $r):?>
