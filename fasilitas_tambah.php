...
<form method="post" action="?m=fasilitas_tambah" enctype="multipart/form-data">    
    <div class="row">
        <div class="col-sm-6">
            <?php if($_POST) include 'aksi.php'?>
            <div class="form-group">
                <label>Nama Tempat <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_fasilitas" value="<?=$_POST['nama_fasilitas']?>"/>
            </div>
            <div class="form-group">
